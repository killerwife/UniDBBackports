...
select * from db_script_string WHERE entry IN (2000005471, 2000005472);
select * from dbscripts_on_creature_movement WHERE id = 55002;
select * from creature where guid IN (75461);
select * from creature_addon WHERE guid IN (32695, 32696);
select * from creature_movement_template WHERE entry IN (21867);
select * from creature_movement WHERE id IN (75461);
select * from creature_linking WHERE guid IN (69097);
select * from creature_linking_template WHERE entry IN (5707, 5701);
select * from creature where id IN (5706);
select * from creature_template where entry IN (21637);
select * from creature_template_addon where entry = 21867;
