...
select * from db_script_string WHERE entry = 2000005477;
select * from dbscripts_on_creature_movement WHERE id = 7273; 
select * from creature where guid IN (75774);
...
select * from creature where id IN (21720);
select * from creature_template where entry = 7273;
select * from creature_template_addon where entry = 21454;
